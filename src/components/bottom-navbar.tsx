...
const BottomNavbar: React.FC = () => {
  return (
    <nav className="rounded-t-3xl fixed bottom-0 inset-x-0 bg-purple-100 flex justify-between text-sm text-purple-900 uppercase font-mono">
      ...
      {/* Bouton compte */}
      <Link to="/account" className="w-full block rounded-t-3xl py-5 px-3 text-center hover:bg-purple-200 hover:text-purple-800">
        <svg className="w-6 h-6 mb-2 mx-auto" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      {/* Bouton settings */}
      <Link to="/settings" className="w-full block rounded-t-3xl py-5 px-3 text-center hover:bg-purple-200 hover:text-purple-800">
        <svg className="w-6 h-6 mb-2 mx-auto" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
